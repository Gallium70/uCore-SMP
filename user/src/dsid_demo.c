...
int main(int argc, char *argv[])
{
    DsidParam dsid_param[] = {
        ...
        // asymmetric 10:0.5
        // mem limited, cache isolated
        {7800, 0x800, 100, 0xFFC0}, // 10016 17
        {7800, 0x800, 5, 0x0030},   // 500   18
        // mem limit, cache shared
        {7800, 0x800, 100, 0xFFF0}, // 10016 19
        {7800, 0x800, 5, 0xFFF0},   // 500   20

        // 0.1
        {7800, 0x800, 1, 0x0010}, // 100   21

        // monitor
        {10000, 0x800, 10, 0x000F}, // 3125 22
        {10000, 0x800, 20, 0x000F}, // 3125 23
        {10000, 0x800, 40, 0x000F}, // 3125 24
    };
